                            ...
                            <div className="space-y-8 max-w-lg">
                                ...
                                <div className="space-y-6">
                                    <Slider
                                        ...
                                        unit="kcal"
                                        infoText="This is the total calories you plan to consume each day."
                                    />
                                    ...
                                    <Slider
                                        ...
                                        unit="kcal"
                                        infoText="This is the total calories you plan to burn each day through exercise and activity."
                                    />
                                </div>
                            </div>
                        </div>
