        ...
        <form onSubmit={handleSubmit} className="login-form">
            ...
            <div className="mt-4">
                    ...
                    <div className ="relative mt-2">
                        ...
                        type={showPassword ? 'text': 'password'} placeholder="Please enter your password" className= "login-input pr-10"required/>
                ...
                : (
                    <p className="text-center py-6 text-sm text-gray-500 dark:text-gray-400">Already have an account? <button onClick={()=> setState('login')}className="ml-1 cursor-pointer text-green-600 hover:underline">Sign in</button></p>
                )}
        </form>
        </main>
        </>
