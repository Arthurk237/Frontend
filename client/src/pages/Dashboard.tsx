...
import CaloriesChart from "../component/ui/CaloriesChart.tsx"
        ...
        {user && (
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold text-slate-700 dark:text-slate-200">{user.weight ?? "--"}{user.weight ? " kg" : ""}</span>
            </div>
           {user.height && (
           <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
